                                  ...
                                  int min_i, int min_j, int max_i, int max_j, bool fill_polygon)
{
    ...
    for (unsigned int i = 0; i < polygon.size(); ++i) 
    {
        ...
        // printf("------------------------------------- \n");
        // printf("loc.x: %d \n", loc.x);
        // printf("master_grid.getSizeInCellsX(): %d \n", master_grid.getSizeInCellsX());
        // printf("master_grid.getSizeInMetersX(): %.f \n", master_grid.getSizeInMetersX());
        // printf("------------------------------------- \n");
        // printf("loc.y: %d \n", loc.y);
        // printf("master_grid.getSizeInCellsY(): %d \n", master_grid.getSizeInCellsY());
        // printf("master_grid.getSizeInMetersY(): %.f \n", master_grid.getSizeInMetersY());
        // if(loc.x >= 0 && loc.y >= 0)
        // {
